...
const ShipItemFormAdd = ({ register, remove, index, onChangeMaxWeight, items, errors }: ShipItemFormAddProps) => {
    return (
...
export default ShipItemFormAdd