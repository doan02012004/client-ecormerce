...
import { TypeProduct, TypeProductModels } from '@/schemas/product'
...
const FormFieldVariant = ({ models, setValue }: FormFieldVariantProps) => {
    ...
    const fieldAllDataVariant = useCallback((data: dataForm, models: TypeProductModels) => {
