...
const InforShipProduct = () => {
    ...
    const { register, formState: { errors } } = useFormContext<IproductFromAdd>()
    return (
        <div className='px-2 py-4 rounded-lg bg-white'>
            ...
            <div className='px-6 flex flex-col gap-4'>
                ...
                <div className='grid grid-cols-[100px_auto] gap-3 '>
                    ...
                    <div>
                        <input type="number" {...register('sku')} placeholder='Sku...' className={` ${errors?.sku && 'border-red-500'} w-full h-full text-sm pl-2 pr-12 py-2 border outline-0 focus:outline-1 focus:outline-blue-500`} />
