...
const InforbaseProductEdit = () => {
    const { register, formState:{errors}, watch, setValue, control } = useFormContext<IproductFormEdit>()
    ...
    return (
        <div className='px-2 py-4 rounded bg-white'>
            {/* header  */}
            ...
            <div className='px-6 flex flex-col gap-8'>
                ...
                <div className='grid grid-cols-[100px_auto] gap-3 items-center' >
                    ...
                    <div>
                        ...
                        {imagesData.length == 0 && (<p className='text-red-500 text-xs'>Lưu ý ảnh đầu tiên sẽ là ảnh bìa của sản phẩm</p>)}
                    </div>
                </div>
                {/* Tên sp  */}
