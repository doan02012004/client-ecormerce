...
import { TypeProductEdit, TypeProductModelEdit } from '@/schemas/product'



type VariantItemProps  ={
    model:TypeProductModelEdit,
    index:number,
    register:UseFormRegister<TypeProductEdit>,
    errors:FieldErrors<TypeProductEdit>
}
